...
static const char qt_meta_stringdata_caTextEntry[] = {
    ...
    "framePresent\0QColor\0frameColor\0int\0"
...
int caTextEntry::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: *reinterpret_cast< bool*>(_v) = getFrame(); break;
        case 2: *reinterpret_cast< QColor*>(_v) = getFrameColor(); break;
        case 3: *reinterpret_cast< int*>(_v) = getLineWidth(); break;
        case 4: *reinterpret_cast< alertHandling*>(_v) = getAlarmHandling(); break;
        }
        _id -= 5;
        ...
        case 2: setFrameColor(*reinterpret_cast< QColor*>(_v)); break;
        case 3: setLinewidth(*reinterpret_cast< int*>(_v)); break;
        case 4: setAlarmHandling(*reinterpret_cast< alertHandling*>(_v)); break;
        }
        _id -= 5;
