...
static const char qt_meta_stringdata_SNumeric[] = {
    "SNumeric\0\0valueChanged(double)\0"
...
const QMetaObjectExtraData SNumeric::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SNumeric::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_SNumeric,
      qt_meta_data_SNumeric, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SNumeric::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SNumeric))
