...
**
** Created: Thu Dec 4 10:19:21 2014
...
static const uint qt_meta_data_caSpinbox[] = {
 ...
 // enum data: key, value
     133, uint(caSpinbox::Channel),
     141, uint(caSpinbox::User),

       0        // eod
};

static const char qt_meta_stringdata_caSpinbox[] = {
    "caSpinbox\0QString\0channel\0QColor\0"
...
const QMetaObjectExtraData caSpinbox::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject caSpinbox::staticMetaObject = {
    { &SNumeric::staticMetaObject, qt_meta_stringdata_caSpinbox,
      qt_meta_data_caSpinbox, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &caSpinbox::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_caSpinbox))
