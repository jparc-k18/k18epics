...
**
** Created: Thu Dec 4 10:18:38 2014
...
static const uint qt_meta_data_caSlider[] = {
 ...
 // enum data: key, value
     188, uint(caSlider::Up),
     191, uint(caSlider::Down),
     196, uint(caSlider::Left),
     201, uint(caSlider::Right),
     207, uint(caSlider::Default),
     215, uint(caSlider::Static),
     222, uint(caSlider::Alarm),
     228, uint(caSlider::Channel),
     236, uint(caSlider::User),

       0        // eod
};

static const char qt_meta_stringdata_caSlider[] = {
    "caSlider\0Qt::Orientation\0orientation\0"
    ...
    "maxValue\0minValue\0incrementValue\0value\0"
