...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        xmlrpc_server_abyss_add_method_w_doc((char*)"archiver.info",     &get_info,     0, (char*)"S:", (char*)"Get info");
        xmlrpc_server_abyss_add_method_w_doc((char*)"archiver.archives", &get_archives, 0, (char*)"A:", (char*)"Get archives");
        xmlrpc_server_abyss_add_method_w_doc((char*)"archiver.names",    &get_names,    0, (char*)"A:is", (char*)"Get channel names");
        xmlrpc_server_abyss_add_method_w_doc((char*)"archiver.values",   &get_values,   0, (char*)"A:iAiiiiii", (char*)"Get values");
